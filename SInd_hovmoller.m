...
ii = 48; %choose by visually identifying ventilation regions on streamline plots
...
xticklabels({'20E','40E','60E','80E','100E','120E'})
...
advect_linex(end) = NaN;
advect_liney(end) = NaN;
...
%saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/NInd_hovmoller_PV.png')
%saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/NInd_hovmoller_PV.fig')
