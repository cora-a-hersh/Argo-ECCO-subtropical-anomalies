...
for isig = [28,38,44,54]
    ...
    data = squeeze(argo_ecco_corrcoef_pr(:,:,isig));
	interval = 0.15;
	mask = squeeze(pvalue_pr(:,:,isig)) <= 0.05;

    subaxis(2,2,aa,'SpacingVert',0.01,'SpacingHoriz',0.01)
    levels = -1:0.2:1;
...
saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/pressure_pointwise_correlation.png');
saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/pressure_pointwise_correlation.fig');
