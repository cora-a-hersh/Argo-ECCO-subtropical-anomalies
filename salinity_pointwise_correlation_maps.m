...
for isig = [28,38,44,54]
    ...
    data = squeeze(argo_ecco_corrcoef_sa(:,:,isig));
    interval = 0.05;
    mask = squeeze(pvalue_sa(:,:,isig)) <= 0.05;
...
saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/sal_pointwise_correlations.png');
saveas(gcf,'/atalanta/home/chersh/SpiceAnomalies/Paper1_figures/sal_pointwise_correlations.fig');
